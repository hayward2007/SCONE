...
\cite{saranli2001rhex,altendorfer2001rhex}, and the X-RHex family carried that
morphology into a research platform \cite{galloway2010xrhex}. Whegs abstracted
...
actuation. A third family keeps a wheel drive alongside a full leg: Cassino
Hexapod III places omni-wheels at anthropomorphic leg tips
...
Learned controllers have become the standard way to obtain robust legged
locomotion \cite{hwangbo2019learning,lee2020learning,miki2022learning,rudin2022minutes},
and residual formulations keep a structured reference while learning only a
correction \cite{johannink2019residual,silver2018residual}. We use a residual
policy only in the low-speed regime of the deployment stack and, as
Sec.~\ref{sub:residual} makes explicit, it is inactive at the operating point of
...
separately in Sec.~\ref{sec:results}. H2: coordinated articulation expands the
climbable stair set beyond the geometric limit of arc rotation alone.
